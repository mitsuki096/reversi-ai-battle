...
public class SearchResult {
    ...
    public void setBestMove(Move bestMove) { this.bestMove = bestMove; }
    ...
    public long getThinkingTimeMillis() { return thinkingTimeMillis; }
    public void setThinkingTimeMillis(long thinkingTimeMillis) { this.thinkingTimeMillis = thinkingTimeMillis; }
}
